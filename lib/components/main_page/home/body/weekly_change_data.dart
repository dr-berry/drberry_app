  ...
  Widget build(BuildContext context) {
    ...
    Widget getMessage() {
      if (context.watch<HomePageProvider>().mainPageBiometricData != null &&
        ...
        final provider = context.watch<HomePageProvider>().mainPageBiometricData!.sleepSuming!;
          ...
          return RichText(
              ...
              text: TextSpan(style: DefaultTextStyle.of(context).style, children: const [
                TextSpan(
                  ...
                  style: TextStyle(fontFamily: 'Pretendard', fontSize: 16, fontWeight: FontWeight.w400),
                ),
              ]));
          ...
          return RichText(
              ...
              text: TextSpan(style: DefaultTextStyle.of(context).style, children: [
                ...
                TextSpan(
                    ...
                    style: const TextStyle(fontFamily: 'Pretendard', fontSize: 16, fontWeight: FontWeight.w600)),
                const TextSpan(
                        ...
                        child: Stack(
                          children: [
                            ...
                            Positioned(
                              ...
                              left: 0,
                              right: 0,
                              child: context.watch<HomePageProvider>().mainPageBiometricData != null &&
                                      context.watch<HomePageProvider>().mainPageBiometricData!.userBiometricData != null
                                  ? context.watch<HomePageProvider>().mainPageBiometricData!.sleepSuming!.lastScore ==
                                          null
