...
class SnoringWidget extends StatefulWidget {
  ...
  const SnoringWidget(
      {super.key,
      required this.defaultBoxDecoration,
      required this.snoringKey});
...
class _SnoringWidgetState extends State<SnoringWidget> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      RenderBox box =
          _snoringWidgetKey.currentContext?.findRenderObject() as RenderBox;
      setState(() {
    ...
    Widget setSnoringDetail() {
      ...
      if (context.read<HomePageProvider>().mainPageBiometricData != null &&
        ...
        for (var i = 0; i < count.length; i++) {
          ...
          try {
            percent = snoringPercents
                .firstWhere((element) => element.snoringLevel == levels[i]);
