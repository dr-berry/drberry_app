...
class MainPageBiometricData {
  ...
  factory MainPageBiometricData.fromJson(Map<String, dynamic> json) {
    ...
    return MainPageBiometricData(
        ...
        simpleSleepData:
            SimpleSleepData.fromJson(json["components"][0]["simpleSleepData"]),
        sleepHistoryGague: SleepHistoryGague.fromJsonList(
            json['components'][0]['sleepHistoryGauge']),
        ...
        sleepPatternGraphData: SleepPatternGraphData.fromJsonList(
            json['components'][5]['sleepPatternGraphData']),
        sleepPatternGraphX: SleepPatternGraphX.fromJsonList(
            json['components'][5]['sleepPatternGraphX']),
        sleepPatternNeedDataNum: SleepPatternNeedDataNum.fromJsonList(
            json['components'][5]['sleepPatternNeedDataNum']),
        sleepPatternDetailData: SleepPatternDetailData.fromJson(
            json['components'][5]['sleepPatternDetailData']),
        wakeupQualityGraphData: SleepPatternGraphData.fromJsonList(
            json['components'][6]['wakeupQualityGraphData']),
        wakeupQualityDetailData: WakeupQualityDetailData.fromJson(
            json['components'][6]['wakeupQualityDetailData'],
            json['components'][6]['wakeupWhenWakeTime']),
        heartRateGraph:
            HeartRateGraph.fromJsonList(json['components'][7]['heartRateGraph']),
        ...
        nosingDetailData: NosingDetailData.fromJson(json['components'][9]['nosingDetailData'], json['components'][9]['nosingDetailPercent']),
...
class UserBiometricData {
  ...
  factory UserBiometricData.fromJson(Map<String, dynamic> json) {
    return UserBiometricData(
        ...
        ussSeq: json["ussSeq"],
        measurementAt: json["measurementAt"]);
  }
...
class TodayEvent {
  ...
  TodayEvent(
      ...
      required this.lastDayScore,
      required this.thisDayScore});
...
class SleepPatternGraphData {
  ...
  SleepPatternGraphData(
      {required this.sleepPattern, required this.measurementAt});

  factory SleepPatternGraphData.fromJson(Map<String, dynamic> json) {
    return SleepPatternGraphData(
        sleepPattern: json['sleepPattern'],
        measurementAt: json['measurementAt']);
  }
    ...
    for (Map<String, dynamic> element in jsonList) {
      if (element['measurementAt'] is String) {
        ...
        result.add(SleepPatternGraphData.fromJson({
          "sleepPattern": element['sleepPattern'],
          "measurementAt": "${element['measurementAt']}"
        }));
      }
    }
...
class WakeupQualityDetailData {
  ...
  factory WakeupQualityDetailData.fromJson(
      Map<String, dynamic> json, Map<String, dynamic> whenJson) {
...
class HeartRateGraph {
  ...
  factory HeartRateGraph.fromJson(Map<String, dynamic> json) {
    return HeartRateGraph(
        heartRate: json['heartRate'], mesurementAt: json['mesurementAt']);
  }
...
class HeartRateGraphY {
  ...
  factory HeartRateGraphY.fromJson(Map<String, dynamic> json) {
    return HeartRateGraphY(
        maxHeartRate: json['maxHeartRate'], minHeartRate: json['minHeartRate']);
  }
}
...
class TossNTurnDetailData {
  ...
  TossNTurnDetailData(
      {required this.tossNTurnCnt,
      required this.tossNTurnPercent,
      required this.tossNTurnScore});
...
class NosingGraph {
  ...
  NosingGraph(
      {required this.snoringLevel,
      required this.avgSnoring,
      required this.date,
      required this.levelCnt});
...
class NosingDetailData {
  ...
  factory NosingDetailData.fromJson(
      Map<String, dynamic> json, Map<String, dynamic> dpJson) {
...
class NosingPartPercent {
  ...
  factory NosingPartPercent.fromJson(Map<String, dynamic> json) {
    return NosingPartPercent(
        snoringLevel: json['snoringLevel'], cnt: json['cnt']);
  }
