...
final $typed_data.Uint8List s0SessionRespDescriptor = $convert.base64Decode(
    'Cg1TMFNlc3Npb25SZXNwEikKBnN0YXR1cxgBIAEoDjIRLmVzcHJlc3NpZi5TdGF0dXNSBnN0YX'
    'R1cw==');
...
const Sec0Payload$json = {
  '1': 'Sec0Payload',
  '2': [
    {'1': 'msg', '3': 1, '4': 1, '5': 14, '6': '.espressif.Sec0MsgType', '10': 'msg'},
    {'1': 'sc', '3': 20, '4': 1, '5': 11, '6': '.espressif.S0SessionCmd', '9': 0, '10': 'sc'},
    {'1': 'sr', '3': 21, '4': 1, '5': 11, '6': '.espressif.S0SessionResp', '9': 0, '10': 'sr'},
  ],
  '8': [
    {'1': 'payload'},
  ],
...
final $typed_data.Uint8List sec0PayloadDescriptor = $convert.base64Decode(
    'CgtTZWMwUGF5bG9hZBIoCgNtc2cYASABKA4yFi5lc3ByZXNzaWYuU2VjME1zZ1R5cGVSA21zZx'
    'IpCgJzYxgUIAEoCzIXLmVzcHJlc3NpZi5TMFNlc3Npb25DbWRIAFICc2MSKgoCc3IYFSABKAsy'
    'GC5lc3ByZXNzaWYuUzBTZXNzaW9uUmVzcEgAUgJzckIJCgdwYXlsb2Fk');
