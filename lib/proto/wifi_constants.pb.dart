...
class WifiConnectedState extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'WifiConnectedState', package: const $pb.PackageName(_omitMessageNames ? '' : 'espressif'), createEmptyInstance: create)
